...
exports.default = fixChildrenOrder;
 ...
 */
function fixChildrenOrder(props, selection) {
  const source = _react.Children.toArray(props.children);
  const children = [];
...
//# sourceMappingURL=fixChildrenOrder.js.map